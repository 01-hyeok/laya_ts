...
DATA="ETTm2"
DATA_SLUG="ettm2"
DATA_PATH="${DATA_PATH:-../Dataset/Time-Series-Library_dataset/ETT-small/ETTm2.csv}"
...
SAVE_DIR="${SAVE_DIR:-./checkpoints/${DATA_SLUG}_${ARCH}_ci_none}"
LOG_DIR="${LOG_DIR:-./runs/pretrain_${DATA_SLUG}_${ARCH}_ci_none}"
