...
SAVE_DIR="${SAVE_DIR:-./checkpoints/${DATA}_${ARCH}_mixer_text_stats_joint}"
LOG_DIR="${LOG_DIR:-./runs/pretrain_${DATA}_${ARCH}_mixer_text_stats_joint}"

export LAYA_TS_LOG_TEXT_METADATA_PREVIEW="${LOG_TEXT_METADATA_PREVIEW}"
export LAYA_TS_DEBUG_LOTSA="${DEBUG_LOTSA}"

echo "🚀 Laya-TS Pretraining: ${DATA} (${ARCH} + mixer_text_stats_joint)"
