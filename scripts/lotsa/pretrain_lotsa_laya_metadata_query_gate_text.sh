...
SAVE_DIR="${SAVE_DIR:-./checkpoints/${DATA}_${ARCH}_metadata_query_gate_text}"
LOG_DIR="${LOG_DIR:-./runs/pretrain_${DATA}_${ARCH}_metadata_query_gate_text}"
...
echo "🚀 Laya-TS Pretraining: ${DATA} (${ARCH} + metadata_query_gate_text)"
