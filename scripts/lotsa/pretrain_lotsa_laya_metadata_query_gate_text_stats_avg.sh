...
SAVE_DIR="${SAVE_DIR:-./checkpoints/${DATA}_${ARCH}_metadata_query_gate_text_stats_avg}"
LOG_DIR="${LOG_DIR:-./runs/pretrain_${DATA}_${ARCH}_metadata_query_gate_text_stats_avg}"

export LAYA_TS_LOG_TEXT_METADATA_PREVIEW="${LOG_TEXT_METADATA_PREVIEW}"
export LAYA_TS_DEBUG_LOTSA="${DEBUG_LOTSA}"

echo "🚀 Laya-TS Pretraining: ${DATA} (${ARCH} + metadata_query_gate_text_stats_avg)"
