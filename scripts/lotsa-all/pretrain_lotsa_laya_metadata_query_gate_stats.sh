...
SAVE_DIR="${SAVE_DIR:-./checkpoints/${RUN_DATA}_${ARCH}_metadata_query_gate_stats}"
LOG_DIR="${LOG_DIR:-./runs/pretrain_${RUN_DATA}_${ARCH}_metadata_query_gate_stats}"

export LAYA_TS_DEBUG_LOTSA="${DEBUG_LOTSA}"


echo "🚀 Laya-TS Pretraining: ${RUN_DATA} (${ARCH} + metadata_query_gate_stats)"
