...
SAVE_DIR="${SAVE_DIR:-./checkpoints/${RUN_DATA}_${ARCH}_metadata_query_gate_text_stats_avg}"
LOG_DIR="${LOG_DIR:-./runs/pretrain_${RUN_DATA}_${ARCH}_metadata_query_gate_text_stats_avg}"

export LAYA_TS_LOG_TEXT_METADATA_PREVIEW="${LOG_TEXT_METADATA_PREVIEW}"
export LAYA_TS_DEBUG_LOTSA="${DEBUG_LOTSA}"

echo "🚀 Laya-TS Pretraining: ${RUN_DATA} (${ARCH} + metadata_query_gate_text_stats_avg)"
...
EXTRA_ARGS=(
  --attention_map_tag metadata_query_gate_text_stats_avg
