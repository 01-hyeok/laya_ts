...
# to restrict training to an explicit subset list.
...
SAVE_DIR="${SAVE_DIR:-./checkpoints/${RUN_DATA}_${ARCH}_ci_none}"
LOG_DIR="${LOG_DIR:-./runs/pretrain_${RUN_DATA}_${ARCH}_ci_none}"

export LAYA_TS_DEBUG_LOTSA="${DEBUG_LOTSA}"


echo "🚀 Laya-TS Pretraining: ${RUN_DATA} (${ARCH} + ci)"
