...
SAVE_DIR="${SAVE_DIR:-./checkpoints/${RUN_DATA}_${ARCH}_metadata_query_gate_text}"
LOG_DIR="${LOG_DIR:-./runs/pretrain_${RUN_DATA}_${ARCH}_metadata_query_gate_text}"
...
echo "🚀 Laya-TS Pretraining: ${RUN_DATA} (${ARCH} + metadata_query_gate_text)"
...
EXTRA_ARGS=(
  --attention_map_tag metadata_query_gate_text
