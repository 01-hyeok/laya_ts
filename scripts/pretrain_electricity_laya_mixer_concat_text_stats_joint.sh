...
SAVE_DIR="${SAVE_DIR:-./checkpoints/${DATA}_${ARCH}_mixer_concat_text_stats_joint}"
LOG_DIR="${LOG_DIR:-./runs/pretrain_${DATA}_${ARCH}_mixer_concat_text_stats_joint}"
...
echo "🚀 Laya-TS Pretraining: ${DATA} (${ARCH} + mixer_concat_text_stats_joint)"
