...
SAVE_DIR="${SAVE_DIR:-./checkpoints/${DATA}_${ARCH}_mixer_text_stats_avg}"
LOG_DIR="${LOG_DIR:-./runs/pretrain_${DATA}_${ARCH}_mixer_text_stats_avg}"
...
echo "🚀 Laya-TS Pretraining: ${DATA} (${ARCH} + mixer_text_stats_avg)"
