...
SAVE_DIR="${SAVE_DIR:-./checkpoints/${DATA}_${ARCH}_attention_suppress_gate_text_stats_joint}"
LOG_DIR="${LOG_DIR:-./runs/pretrain_${DATA}_${ARCH}_attention_suppress_gate_text_stats_joint}"


export LAYA_TS_LOG_TEXT_METADATA_PREVIEW="${LOG_TEXT_METADATA_PREVIEW}"

echo "🚀 Laya-TS Pretraining: ${DATA} (${ARCH} + attention_suppress_gate_text_stats_joint)"
...
EXTRA_ARGS=(
  --attention_map_tag attention_suppress_gate_text_stats_joint
