...
MODEL_TAG="electricity_laya_metadata_query_gate_text_stats_avg"
...
OUT_DIR="${OUT_DIR:-./analysis/linear_probe_ablation/metadata_query_gate_text_stats_avg_ETTm1_96}"
DEVICE="${DEVICE:-cuda}"
SEED="${SEED:-42}"
