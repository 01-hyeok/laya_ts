...
MODEL_TAG="electricity_laya_metadata_query_gate_stats"
...
CHANNEL_MIXER_TYPE="${CHANNEL_MIXER_TYPE:-mixer}"
...
OUT_DIR="${OUT_DIR:-./analysis/linear_probe_ablation/metadata_query_gate_stats_ETTm1_96}"
DEVICE="${DEVICE:-cuda}"
SEED="${SEED:-42}"
