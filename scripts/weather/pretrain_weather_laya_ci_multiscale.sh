...
ARCH="laya"
VARIANT="${VARIANT:-s}"
MODEL_ID="${MODEL_ID:-laya_ci_multiscale}"
...
PATCHIFIER_MODE="${PATCHIFIER_MODE:-multiscale}"
...
EXPERIMENT_NAME="${EXPERIMENT_NAME:-laya_ci_multiscale}"
...
SAVE_DIR="${SAVE_DIR:-./checkpoints/${DATA_SLUG}_${ARCH}_${EXPERIMENT_NAME}}"
LOG_DIR="${LOG_DIR:-./runs/pretrain_${DATA_SLUG}_${EXPERIMENT_NAME}}"
...
echo "📝 multiscale: mode=${PATCHIFIER_MODE}, sizes=${MULTISCALE_PATCH_SIZES}, base=${MULTISCALE_BASE_PATCH}, temp=${MULTISCALE_GATE_TEMPERATURE}"
