...
DATA="tsld"
DATA_PATH="${DATA_PATH:-../Dataset/TSLD-1G}"

ARCH="laya"
VARIANT="${VARIANT:-s}"
LAYA_MODE="${LAYA_MODE:-mixer}"
TSLD_MODE="${TSLD_MODE:-multivariate}"
...
SAVE_DIR="${SAVE_DIR:-./checkpoints/${DATA}_${ARCH}_mixer_text}"
LOG_DIR="${LOG_DIR:-./runs/pretrain_${DATA}_${ARCH}_mixer_text}"
