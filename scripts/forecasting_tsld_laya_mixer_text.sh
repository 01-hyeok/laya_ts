...
PRETRAIN_SCRIPT="laya_ts/scripts/pretrain_tsld_laya_mixer_text.sh"
...
if [ ! -f "$CHECKPOINT" ]; then
  ...
  echo "Please run $PRETRAIN_SCRIPT first, or override CHECKPOINT=/path/to/laya_ts_${PRETRAIN_DATA}_s_best.pt"
  exit 1
fi
